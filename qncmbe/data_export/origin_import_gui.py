...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.export_button.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        MainWindow.setTabOrder(self.file, self.export_button)
        MainWindow.setTabOrder(self.export_button, self.runtime_messages)
...
"Make sure insitu has up-to-date data before running this script! (Molly binaries and SVT data may need to be synced.)"))
        ...
        self.export_button.setText(_translate("MainWindow", "Import data!"))
